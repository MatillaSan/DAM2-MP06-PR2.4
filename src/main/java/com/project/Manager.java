...
public class Manager {
    ...
    public static void updateLlibre(long llibreId, String nom, String editoral, Autor autor,
            Set<Biblioteca> biblioteques, Set<Persona> persones) {
        Session session = factory.openSession();
        Transaction tx = null;
        try {
            tx = session.beginTransaction();
